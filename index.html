...
<html lang="en">
  <head>
    ...
    <title>BabaYaga | Everything</title>
 ...
 <div class="commonProperty experienceSectoin">
  <div class="box box1">
      ...
      <section class="section scrollspy" id="contact">
        <h1>CONTACT</h1>
        <div class="commonProperty contactSection">
          <div class="box box1">
            <a href="https://twitter.com/lit__guy" target="_blank">
              <i class="fab fa-twitter"></i>
            </a>
          </div>
          <div class="box box2">
            <a href="https://www.instagram.com/khitish_panigrahi/" target="_blank">
